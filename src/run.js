            ...
            for (let t = 0; t < o; t++) {
                ...
                !l(o, f)) {
                    ...
                    const t = o.color === e.settings.color ? null : o.color
                      , n = o.backgroundColor === e.settings.backgroundColor ? null : o.backgroundColor
...
var s = {
    ...
    render: function(e, t) {
        const o = e.settings.element
          ...
          , a = e.settings;
        a.canvasSize ? (o.width = a.canvasSize.width * n,
        o.height = a.canvasSize.height * n,
        o.style.width = a.canvasSize.width + "px",
        o.style.height = a.canvasSize.height + "px") : (o.width = e.width * n,
        o.height = e.height * n);
        ...
        if ("center" == a.textAlign)
            for (let e = 0; e < l; e++) {
                ...
                for (let e = 0; e < r; e++) {
                    const o = t[l + e]
                      , n = a;
                    o.backgroundColor && o.backgroundColor != f && (p.fillStyle = o.backgroundColor || f,
            ...
            for (let e = 0; e < l; e++)
                for (let o = 0; o < r; o++) {
                    const n = t[e * r + o]
                      , l = o * i
                      , s = e * c;
                    n.backgroundColor && n.backgroundColor != f && (p.fillStyle = n.backgroundColor || f,
...
class i {
    ...
    update(e) {
        return this.frames++,
        e >= this.ptime + 1e3 && (this.fps = 1e3 * this.frames / (e - this.ptime),
        this.ptime = e,
        this.frames = 0),
        this.fps
    }
...
const f = {
  ...
  , u = ["backgroundColor", "color", "fontFamily", "fontSize", "fontWeight", "letterSpacing", "lineHeight", "textAlign"];
function p(e, t, o={}) {
    return new Promise((function(n) {
        const r = {
          ...
          , s = "currentState";
        let d;
        r.restoreState && (a(s, l),
        l.cycle++),
        r.element ? "canvas" == r.renderer ? "CANVAS" == r.element.nodeName ? d = f[r.renderer] : console.warn("This renderer expects a canvas target element.") : "CANVAS" != r.element.nodeName ? d = f[r.renderer] : console.warn("This renderer expects a text target element.") : (d = f[r.renderer] || f.text,
        r.element = document.createElement(d.preferredElementNodeName),
        document.body.appendChild(r.element));
        for (const e of u)
            r[e] && (r.element.style[e] = r[e]);
        const p = []
          , m = {
            x: 0,
            y: 0,
        ...
        document.fonts.ready.then((t => {
            let n = 3;
            !function t() {
                --n > 0 ? requestAnimationFrame(t) : function() {
                    x = b(r.element);
                    const t = g(l, r, x, w);
        ...
        function M(t) {
            const i = t - v;
            if (i < k)
                return void (r.once || requestAnimationFrame(M));
            const a = g(l, r, x, w);
            w.update(t),
            v = t - i % k,
            l.time = t + N,
            ...
            if ("function" == typeof e.pre && e.pre(a, f, C, o),
            ...
            for ("function" == typeof e.post && e.post(a, f, C, o),
            d.render(a, C, r); p.length > 0; ) {
                const t = p.shift();
                t && "function" == typeof e[t] && e[t](a, f, C)
            }
            r.once || requestAnimationFrame(M),
            n(a)
        }
    }
    ))
